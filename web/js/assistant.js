...
jQuery(document).ready(function ($) {
    $("#assistant").mousedown(function (e) {
        if (e.which == 3) {
            showMessage("恭喜你，发现秘密通道(●'◡'●)♥:<br/><br/><a href=\"http://www.baidu.com\" title=\"百度\">百度</a><br/><br/><a href =\"https://github.com/zxcv8556723/SouSou\" title=\"此项目源码github\">此项目源码github</a>", 10000, 10000
            )
            ;
        }
    });
